...
ng_mu_lowerbound=0.000001; % 1/h - lower bound of non-growing population growth rate
...
IG=[
    1000    % nongrowing population initial FI mean
    100     % nongrowing population FI stdev
    2e+07  % nongrowing population cell concentration
    ...
    100         % growing population initial FI mean
    10          % unstained cell background autofluorescence
    ];
% bounds for parameters (lower / upper)
bounds= [
            500   15000     % nongrowing population initial FI mean
            10       500      % nongrowing population FI stdev
            1E3       1E9   % nongrowing population cell concentration 
            ...
            20       500    % growing population initial FI mean
